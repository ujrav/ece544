...
def discriminator_classify(data, n_classes, feature_size = 1024, layer_name="c_classifier_n"):
...
def discriminator_classify_exclusive(data, n_classes, feature_size = 1024, layer_name="c_classifier_n"):
